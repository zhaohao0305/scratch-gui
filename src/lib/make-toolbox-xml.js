...
const motion = function (isInitialSetup, isStage, targetId) {
    ...
    <block type="motion_select">
    
    </block>
    <block type="motion_endanimation">
    ...
    <block type="motion_end" />
  
   
    <block type="motion_left90" />
    <block type="motion_right90" />
    <block type="motion_role">
    <value name="TO">
...
<block id="${targetId}_yposition" type="motion_zposition"/>
        ...
        <block type="motion_animation">
            <value name="TOWARDS">
                <shadow type="motion_animation_menu">
                </shadow>
             </value>
        </block>
        <block type="motion_startend">
        <value name="TO">
            <shadow type="motion_goto_menu">
            </shadow>
         </value>
...
const physics = function (isInitialSetup, isStage, targetId) {
   
    return `
    <category name="战斗" id="physics" colour="#FF6347" secondaryColour="#3373CC">
        ${isStage ? `
        <label colour="#FF6347" text="请创建角色来开启战斗模块"></label>
        ` : `
    <block type="motion_startwl">
            <value name="DX">
                <shadow type="math_number">
                    <field name="NUM">0</field>
                </shadow>
    ...
    <block type="motion_getattack" />
    <block type="motion_getmodelattack" />
    <block type="motion_keepmove" />
    <block type="motion_attacks" />
    <block type="motion_attackswj" />
    <block type="motion_attackreset" />
    <block type="motion_modelattackreset" />
    <block type="motion_stopkeep" />
     <block type="motion_findmodel">
            <value name="TOWARDS">
                <shadow type="motion_findmodel_menu">
                </shadow>
            </value>
        </block>
    <block type="motion_setrotate">
            <value name="DX">
                <shadow type="math_number">
                    <field name="NUM">0</field>
                </shadow>
    ...
    <block type="motion_follow" />
    <block type="motion_modelchange" />
    <block type="motion_closefollow" />
    <block type="motion_endwl" />
        <block id="${targetId}_direction" type="motion_direction"/>`}
        ${categorySeparator}
    </category>
    `;
...
const looks = function (isInitialSetup, isStage, targetId, costumeName, backdropName) {
    ...
    <category name="%{BKY_CATEGORY_LOOKS}" id="looks" colour="#9966FF" secondaryColour="#774DCB">
        ...
        <block type="looks_animation">
        <value name="TOWARDS">
            <shadow type="looks_animation_menu">
            </shadow>
         </value>
    </block>
    <block type="looks_endanimation">
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const physicsXML = moveCategory('physics') || physics(isInitialSetup, isStage, targetId);
    ...
    if (!hideCatagorys.includes('motion')) { everything.push(motionXML, gap) }
    if (!hideCatagorys.includes('physics')) { everything.push(physicsXML, gap) }
    if (!hideCatagorys.includes('looks')) { everything.push(looksXML, gap) }
    if (!hideCatagorys.includes('sound')) { everything.push(soundXML, gap) }
