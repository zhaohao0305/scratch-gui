...
class GUI extends React.Component {
    ...
    componentDidUpdate (prevProps) {
        ...
        if (this.props.isShowingProject && !prevProps.isShowingProject) {
            ...
            // console.log('loadProjectloadProjectloadProjectloadProject');
...
const mapStateToProps = state => {
    // console.log(state.scratchGui.editorTab.activeTabIndex)
    // console.log(BLOCKS_TAB_INDEX);
...
const mapDispatchToProps = dispatch => ({
    ...
    onActivateSoundsTab: () =>{ 
        // let result = window.mcArr.find(item=>item.sprite.name=="角色1")
        // if(result){
        //   return   alert('别着急等一下')
        // }
